...
import { ReadingLevel as ReadingLevelEnum } from '../types';
import Button from './common/Button';

interface StoryGeneratorProps {
  onGenerate: (readingLevel: ReadingLevel, topic: string) => void;
}
...
const StoryGenerator: React.FC<StoryGeneratorProps> = ({ onGenerate }) => {
  ...
  return (
    <div className="bg-black/30 p-8 rounded-2xl shadow-2xl border border-purple-500/30 flex flex-col items-center max-w-2xl mx-auto animate-fade-in">
      ...
      <p className="text-slate-300 text-center mb-8">Select a reading level and write a topic for your story.</p>
